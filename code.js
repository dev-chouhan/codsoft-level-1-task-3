...
function button_number(button) {
    ...
    box = elem("box");
    last_operation_history = elem("last_operation_history");
    equal = elem("equal_sign").value;
    dot = elem("dot").value;
...
function showSelectedOperator(){
    ...
    if (operator_value == "+"){
        elem("plusOp").style.backgroundColor  = "#ffd11a";
    }
    else if (operator_value == "-"){
        elem("subOp").style.backgroundColor  = "#ffd11a";
    }
    else if (operator_value == "*"){
        elem("multiOp").style.backgroundColor  = "#ffd11a";
    }
    else if (operator_value == "/"){
        elem("divOp").style.backgroundColor  = "#ffd11a";
    }
}
...
function keyPressed(e) {
    e.preventDefault()
    var equal = elem("equal_sign").value;
    var dot = elem("dot").value;
    ...
    if (isNumber || operators.includes(e.key) || e.key == "Enter" || e.key == dotPress || 
        ...
        if (e.key == "Enter"){
            ...
            elem("backspace_btn").style.backgroundColor  = "#999999";
            backspace_remove()
        }
        else if (commaPress){
            button_number(dot)
...
function keyReleased(e){
    ...
    if (e.key == "Backspace"){
        elem("backspace_btn").style.backgroundColor  = "#666666";
    }
}